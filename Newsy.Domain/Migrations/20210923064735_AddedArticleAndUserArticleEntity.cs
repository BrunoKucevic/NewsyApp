...
{
    public partial class AddedArticleAndUserArticleEntity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserArticles", x => new { x.AppUserId, x.ArticleId });
                    table.ForeignKey(
                        name: "FK_AppUserArticles_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppUserArticles_Articles_ArticleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserArticles_ArticleId",
                table: "AppUserArticles",
                column: "ArticleId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUserClaims_AppUsers_UserId1",
                table: "AspNetUserClaims",
                column: "UserId1",
                principalTable: "AppUsers",
                principalColumn: "Id",
