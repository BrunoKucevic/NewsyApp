...
namespace Newsy.Domain.Migrations
{
    ...
    [Migration("20210923132238_AnotherSeeding2")]
    partial class AnotherSeeding2
    {
            ...
            modelBuilder.Entity("Newsy.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "e86c8756-3015-48e9-9cd0-73d4d15b2273",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8f2c1754-ce64-4ad9-a1bd-c687c458a6b4",
                            Name = "Author",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "427a8c31-7ca0-4b2c-9dd9-01bead65c62a",
                            Name = "RegularUser",
            ...
            modelBuilder.Entity("Newsy.Domain.Entities.RoleClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClaimType = "Admin",
                            ClaimValue = "true",
                            RoleId = new Guid("1e969ee3-395c-4d71-8100-a1dd955431e7")
                        },
                        new
                        {
                            Id = 2,
                            ClaimType = "Author",
                            ClaimValue = "true",
                            RoleId = new Guid("8c037fe7-7633-4e2f-b3e0-00a313e7d2e1")
                        });
                });
